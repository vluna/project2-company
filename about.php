<?php
	$title = "About"; 
	$description = "Vancouver Meats is a small company located in lower mainland. We offer hormone and ractopamine free pork and a delicious meat";
...
<section id="about">
	...
	<div id="about-facilities">
		<h3>Facilities</h3>
		<p>All processing, storage and distribution of Vancouver Meats products are performed in federally inspected and HACCP accredited facilities. This ensures the highest levels of quality and food safety. In addition to our stringent Canadian standards, we are also British Retail Consortium (BRC) certified. But the buck doesn’t stop there...</p>
	...
	<div id="about-pork">
		<h3>Pork Attributes</h3>
		<p>Our pigs are vegetable grain fed. No animal bone meal is fed to our pigs. Ever. Our pigs happily nosh on barley, peas, wheat, soy, minerals, and vitamins.</p>
		<p>Barley is one of the main components of our feed rations. This results in fat that is whiter and firmer than what other producers, who use corn as the staple of their pigs’ diet, can offer. The result is a product with a richer texture and taste.</p>
		<p>Our pigs are raised without the use of Dried Distillers Grains with Solubles (DDGS). DDGS is a cheaper feed additive prevalent in the meat industry. Vancouver Meats producers only raise their pigs with premium feeds and without the use of byproducts such as DDGS (a byproduct of ethanol production).</p>
		<p>Our pigs are also raised without the use of Ractopamine, a beta antagonist drug commonly used as an artificial feed additive to promote leanness in pigs and cattle. We grow our pigs in the traditional way. Period.</p>
		<p>Our producers use antibiotics for therapeutic use only under the strict requirements of the Canadian Quality Assurance (CQA). They also use a long withdrawal period that goes above and beyond the guidelines set by Health Canada. This ensures that are no regulatory traces of antibiotics found in any of our products.</p>
		<p>At Vancouver Meats, we make absolutely no compromises when it comes to the care and diet of our hogs. We believe that healthy pigs make for tasty and nutritious pork!</p>
	</div>
	<div id="about-beef">
		<h3>Beef Attributes</h3>
		<p>Vancouver Meats Organic Cattles are raised without the use of:</p>
		<ul>
			<li>Added Hormones</li>
			<li>Antibiotics</li>
			<li>Animal By-products</li>
		</ul>
		<p>At Vancouver Meats, we make absolutely no compromises when it comes to the care and diet of our hogs and cattles. We believe that healthy pigs and cattle make for tasty and nutritious dishes!</p>

		<p>The supplier for our organic beef products is from Canadian Premium Meats(CPM). The CPM has the following certification and audits:</p>
		<ul>
			<li>Halal Ritual Slaughter by Islamic Society of North America (ISNA)</li>
			<li>Organic by Eco Certification</li>
			<li>SGS</li>
			<li>GFTC</li>
		</ul>
	</div>
